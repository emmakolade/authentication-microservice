from .views import RegisterView, RegisterAdminView, VerifyOTPView, LoginView, PasswordResetView, PasswordResetConfirmView, DeleteUserAccountView
from django.urls import path

urlpatterns = [
    path('user/register/', RegisterView.as_view(), name='register'),
    path('user/register/staff/',
         RegisterAdminView.as_view(), name='register-staff'),
